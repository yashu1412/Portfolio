  ...
  const projects: Project[] = [
    {
      id: 1,
      title: "StudyNotion",
      description: "Built a full-stack e-learning platform using the MERN stack, featuring course purchases, progress tracking, reviews, and secure Razorpay payments. Includes instructor and admin tools for course management, with Cloudinary integration for media handling.",
    ...
    },
    {
      ...
      description: "Engineered a Tesla-inspired web application with React 18, TypeScript, and Node.js featuring role-based access control, secure authentication, and an AI-powered customer service chatbot. Integrated Stripe payments, AWS S3 for storage, and comprehensive monitoring.",
      image: teslaBotImg,
